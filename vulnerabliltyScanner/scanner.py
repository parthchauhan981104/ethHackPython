#!/usr/bin/env python
# find xss vulnerability in forms and urls - this works by finding the urls and forms and try to inject the code
...
class Scanner:
    ...
    def crawl(self, url=None):
        if url is None:  # if not in a recursive call
            url = self.target_url
    ...
    def test_xss_in_link(self, url):
        xss_test_script = "<sCript>alert('test')</scriPt>"  # spelling change to pass security filters
